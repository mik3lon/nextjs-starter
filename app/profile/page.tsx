                    ...
                    <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
                        <div
                            ...
                            <div className="relative drop-shadow-2">
                                <Image
                                    src={session.userProfile?.profile_picture_url || "/images/user/user-06.png"}
                                    width={160}
                                    height={160}
                                    style={{
                                        width: "auto",
                        ...
                        <div className="mt-4">
                            <h3 className="mb-1.5 text-2xl font-semibold text-black dark:text-white">
                                {session.userProfile?.name} {session.userProfile?.surname}
                            </h3>
                            <p className="font-medium">{session.userProfile?.role}</p>
                            <div
